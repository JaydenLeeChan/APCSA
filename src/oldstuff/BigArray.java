...
public class BigArray {
    public static void main(String[] args) {
        ...
        for (int lcv = 0; lcv < array.length; lcv++) {
            array[lcv] = (int)(Math.random() * 71 + 20);
        }
        ...
        System.out.println("Average of the first, middle and last numbers in " + (avg/3));
        ...
        //13.Check to see if all of the elements from front
        //to back are in the same order from back to front
        boolean same = true;
        for (int lcv = 0; lcv < array.length; lcv++) {
